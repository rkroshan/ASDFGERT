    ...
    private void setDetails() {
        switch (nitpClub) {
            case "Web and Coding Club":
                ...
                clubLogo.setImageResource(R.mipmap.icon_cm);
                break;
            case "Literary and Art Club":
                ...
                clubLogo.setImageResource(R.mipmap.logo_literaryclub);
                break;
            case "Dance Club":
                nitpClubDetails = "The dance club of NIT Patna aims to create an atmosphere of cultural diversity where students from the various technical branches get an oppurtunity to step-out from their regular academic routine and explore the vibrant world of dance.\n" +
                        "This club provides a platform for students to learn and share their knpwledge of various dance forms also creating\n" +
                        " an integrated group that performs at various events.";
            ...
            case "Music Club":
                nitpClubDetails = "\"All the world's a stage and most of us are desperately unrehearsed\" - Sean O'Casey\n" +
                        ...
                        "The official music club of NIT Patna which provides the students a platform to explore and enhance their engagement in music and a chance to represent their college at big platforms through their talent.";

                clubLogo.setImageResource(R.mipmap.logo_musicclub);
                break;
            ...
            case "Vista":
                ...
                clubLogo.setImageResource(R.mipmap.logo_photographyclub);
                break;
            case "Robotics Club":
                nitpClubDetails = "NA";
                clubLogo.setImageResource(R.mipmap.icon_cm);
